    ...
    <>
      <Flex id={'apropos'} bg={'#DFF6FF'} justify={'space-around'} align={'center'} p={[2, 5, 10]} scrollBehavior={'smooth'}>
        <Flex w={'100%'} bg={'white'} rounded={'2xl'} boxShadow={'2xl'} p={[2, 5, 10]} direction={'column'}>
          <Flex>
            <Heading font-display='optional' fontFamily='Jura' textColor={'#06283D'}>{'01 -'}</Heading><Heading fontFamily='Jura' textColor={'#1363DF'} ml={'15px'}>{'A propos de moi'}</Heading>
          </Flex>
          <Flex w={'100%'} h={'100%'} pt={5}>
            <Flex>
              <Text font-display='optional' fontSize={'17px'} fontFamily='Cutive' maxW={'700px'}>
